...
> **Remediation in progress.** Progress tracking: `docs/HANDOFF-2026-08.md` on branch `remediation/audit-2026-08`. Wave 0 complete (2026-08-25): test deflake, INFRA-3/4/5, gitignore intent rules, zip codec trim, rustdoc fix. Wave 1 complete (2026-08-26): all P1 scopes + PR #108 merged. Wave 2 complete (2026-08-26): P2-llm / P2-audio / P2-pdf / P2-ui-clap landed; PDF-4 refuted with poppler evidence; audio capabilities/estimator CLI+serve wiring in flight as follow-up. Remaining findings pending waves 3–5.
